...
import { cepMask, cnpjMask, isEmailValid, phoneMask } from "../../masks";
...
const FormsEditCompany: React.FC<MyData>= (company) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.put(`//localhost:8088/UpdateAll/${company.cnpj}`, formData);
